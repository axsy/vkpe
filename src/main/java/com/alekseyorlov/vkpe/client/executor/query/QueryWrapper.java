package com.alekseyorlov.vkpe.client.executor.query;

import java.util.concurrent.BlockingQueue;
import java.util.concurrent.Delayed;
import java.util.concurrent.TimeUnit;

import com.alekseyorlov.vkpe.client.executor.query.message.FailedQueryResultMessage;
import com.alekseyorlov.vkpe.client.executor.query.message.QueryResultMessage;
import com.alekseyorlov.vkpe.client.executor.query.message.SuccessfulQueryResultMessage;
